...
class VK
{
	 ...
	 * @return string
	 */
	public function getAuthorizeURL ($api_settings = '', $callback_url = 'http://oauth.vk.com/blank.html', $test_mode = FALSE)
	{
		$parameters = array('client_id'     => $this->app_id, 'scope' => $api_settings, 'redirect_uri' => $callback_url,
							'response_type' => 'code');
	...
	public function getAccessToken ($code, $callback_url = 'http://oauth.vk.com/blank.html')
	{
		...
		$parameters = array('client_id'    => $this->app_id, 'client_secret' => $this->api_secret, 'code' => $code,
