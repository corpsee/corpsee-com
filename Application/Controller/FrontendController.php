...
class FrontendController extends Controller
{
	...
	{
		if (!$language = $this->getRequest()->getSession()->get('user_language'))
		{
			...
			$this->getRequest()->getSession()->set('user_language', $language);
			//$this->container['logger.logger']->info('USER_LANGUAGE SESSION SETS!' . $this->language);
		}
