...
<form name="form-crop" id="form-crop" action="" method="post" enctype="multipart/form-data">
    ...
    <div class="control-group">
        ...
        <div class="control">
            <textarea rows="10" class="text validation" name="description"
                      id="description"><?= $values['description']; ?></textarea>
    ...
    <div class="control-group">
        ...
        <div class="control">
            <input class="text validation" type="text" name="create_date" id="create_date"
