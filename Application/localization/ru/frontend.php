...
<p>В минуты озарения я рисую всяческий <a href="/ru/gallery/list">ужас и мрак</a>, который можно посмотреть на этом сайте.</p>
<p>Все это и даже больше, а так же контакты, по которым со мной можно связаться:</p>',
	...
	'content_403'           => '<h1>Доступ запрещен. 403.</h1><p>Доступ по этому адресу запрещен. Попробуйте <a href="/admin/login" title="Вход для администратора сайта">войти</a> в административную панель.</p>',
