...
sed -e -i "s/${POSTGRESQL_USER}/${POSTGRESQL_USER}/g;s/${POSTGRESQL_PASSWORD}/${POSTGRESQL_PASSWORD}/g;s/${POSTGRESQL_DBNAME}/${POSTGRESQL_DBNAME}/g" ./src/configs/base.php > ./src/configs/base.php
